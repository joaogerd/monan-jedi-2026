...
- Teste reproduzido (quando aplicável)
...
1. Nenhuma execução sem evidência.
2. Nenhuma milestone sem relatório.
3. Nenhuma transição estrutural sem decisão formal.
4. Reprodutibilidade é requisito obrigatório.
5. O board é o único registro oficial de progresso.
